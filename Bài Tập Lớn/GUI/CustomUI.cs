...
namespace Bài_Tập_Lớn.UI
{
    ...
    public class RoundedButton : Button
    {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            using (GraphicsPath path = GraphicsHelper.GetRoundedPath(new Rectangle(0, 0, Width - 1, Height - 1), BorderRadius))
            {
                ...
                Color fill = (isHovering && HoverColor != Color.Empty) ? HoverColor : BackColor;
    ...
    public class RoundedTextBox : UserControl
    {
        ...
        public bool ReadOnly { get => txt.ReadOnly; set => txt.ReadOnly = value; }
        ...
        public RoundedTextBox()
        {
            ...
            txt.Enter += (s, e) => { isFocused = true; Invalidate(); };
            txt.Leave += (s, e) => { isFocused = false; Invalidate(); };
            txt.KeyDown += (s, e) => TextBoxKeyDown?.Invoke(s, e);
            Controls.Add(txt);
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (GraphicsPath path = GraphicsHelper.GetRoundedPath(new Rectangle(0, 0, Width - 1, Height - 1), BorderRadius))
            {
                Color color = isFocused ? FocusColor : BorderColor;
